     ...
     <div class="container">
      <div class="row">
       <div class="col-lg-12 col-md-12">
        ...
        <ul class="menu-logo">
            <li>
                <a href="index-01.html"><img id="logo_img"  class="img-fluid" src="images/logo.png" alt=""></a>
            </li>
        </ul>
        <!-- menu links -->
        <div class="menu-bar">
...
<section class="slider-parallax typer-banner bg-overlay-black-50 parallax" style="background: url(images/bg/01.jpg);">
  <div class="slider-content-middle">
  <div class="container">
     <div class="row">
        <div class="col-lg-12 col-md-12">
         <div class="slider-content text-center">
          <h1 class="text-white">We're <span class="typer" data-delay="150" data-words="Ricky,Vikrant,Manav" data-colors="#84ba3f,#84ba3f,#84ba3f"></span>  <span class="cursor" data-cursorDisplay="|" data-owner="some-id"></span> </h1>
  ...
  <div class="row text-center">
   ...
   <div class="footer-widget mt-20">
    <div class="row">
      ...
      <p class="mt-15">&copy;Copyright <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> <a href="#"> Uka Tarsadia University </a> All Rights Reserved</p>
      </div>
      <div class="col-lg-6 col-md-6 ">
...
<!-- plugin_path -->
<script>var plugin_path = 'Files/js/';</script>
