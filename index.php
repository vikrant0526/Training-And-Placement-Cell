...
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript> -->
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <ul class="menu-logo">
                                        <li>
                                            <a href="index-01.html"><img id="logo_img" class="img-fluid"
 ...
 banner -->
        ...
        <section class="slider-parallax typer-banner bg-overlay-black-50 parallax"
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="slider-content text-center">
                                <h1 class="text-white">We're <span class="typer" data-delay="150"
                                        data-words="Ricky,Vikrant,Manav" data-colors="#84ba3f,#84ba3f,#84ba3f"></span>
                                    <span class="cursor" data-cursorDisplay="|" data-owner="some-id"></span> </h1>
                                <p class="text-white mt-20">We will make your dreams come true</p>
                                <a class="button move mt-30" href="#contact-us"> Let's talk </a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 sm-mb-40">
                        ...
                        <p>Let's make something great together consectetur adipisicing elit. <span class="theme-color"
                                data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="HTML5 template">Webster</span> conseqt quibusdam, enim expedita sed
                    ...
                    <div class="col-lg-6 xs-mt-30 xs-mb-30">
                        <div class="owl-carousel" data-nav-arrow="true" data-items="1" data-md-items="1"
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 xs-mb-30">
                        <div class="feature-text m left-icon mt-60 xs-mt-20">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 sm-mb-30">
                        <div class="counter text-white">
                            ...
                            <span class="timer" data-to="100" data-speed="2500">100</span>
...
key features  -->
        ...
        <section id="services" class="page-section-ptb parallax" data-jarallax='{"speed": 0.6}'
            style="background-image: url(images/bg/07.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="section-title">
                            ...
                            <p>Webster's ultimate, easy to use and customizable UI elements make it most customizable
                                template on the market.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="feature-text left-icon xs-mb-40">
                            ...
                            <div class="feature-info">
                                ...
                                <p>Quia nesciunt dolor sit consectetur <span
                                        data-original-title="Sed hendrerit enim non justo" data-toggle="tooltip"
                                        data-placement="top" class="tooltip-content">conseqt quibusdam,</span> enim
                                    expedita sed </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="feature-text left-icon mb-40">
                            <div class="feature-icon"><span class="ti-image theme-color" aria-hidden="true"></span>
                            </div>
                            <div class="feature-info">
                                <h5 class="text-back">Revolution Slider</h5>
                                <p>Consectetur dolor sit <span data-original-title="Sed hendrerit enim non justo"
                                        data-toggle="tooltip" data-placement="top" class="tooltip-content">conseqt
                                        quibusdam,</span> enim expedita sed quia nesciunt</p>
                            </div>
                        </div>
                        <div class="feature-text left-icon mb-40">
                            <div class="feature-icon">
                        ...
                        <div class="portfolio-item-2">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <div class="hover-icon">
                                    <a class="portfolio-img" href="images/portfolio/small/01.jpg"><i
                    ...
                    <div class="grid-item photography">
                        <div class="portfolio-item-2">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <div class="hover-icon">
                                    <a class="portfolio-img" href="images/portfolio/small/02.jpg"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid-item photography branding">
                        <div class="portfolio-item-2">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <div class="hover-icon">
                                    <a class="portfolio-img" href="images/portfolio/small/03.jpg"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid-item web-design">
                        <div class="portfolio-item-2">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <div class="hover-icon">
                                    <a class="portfolio-img" href="images/portfolio/small/04.gif"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid-item photography illustration">
                        <div class="portfolio-item-2">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <div class="hover-icon">
                                    <a class="portfolio-img" href="images/portfolio/small/05.jpg"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid-item photography">
                        <div class="portfolio-item-2">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <div class="hover-icon">
                                    <a class="portfolio-img" href="images/portfolio/small/06.jpg"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid-item">
                        <div class="portfolio-item-2">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <div class="hover-icon">
                                    <a class="portfolio-img" href="images/portfolio/small/07.jpg"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid-item photography branding">
                        <div class="portfolio-item-2">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <div class="hover-icon">
                                    <a class="portfolio-img" href="images/portfolio/small/08.gif"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid-item illustration">
                        <div class="portfolio-item-2">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <div class="hover-icon">
                                    <a class="portfolio-img" href="images/portfolio/small/09.jpg"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="contact-3-info page-section-ptb">
                            <div class="clearfix">
                                ...
                                <p class="mb-50">It would be great to hear from you! If you got any questions, please do
                                    ...
                                    reply within <span class="tooltip-content-2"
                                        data-original-title="Mon-Fri 10am–7pm (GMT +1)" data-toggle="tooltip"
...
action box- -->
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <p class="mt-15">&copy;Copyright <span id="copyright">
                                ...
                                </span> <a href="#"> Uka Tarsadia University </a> All Rights Reserved</p>
                        </div>
                        <div class="col-lg-6 col-md-6 ">
                            <div class="footer-widget-social text-center text-md-right">
                                <ul>
 ...
 style-customizer  -->
  ...
  <div class="buy-button"> <a class="opener" href="#"><i class="fa fa-cog fa-spin"></i></a> <a target="_blank" class="button button-border" href="https://themeforest.net/item/webster-responsive-multipurpose-html5-template/20904293?ref=Potenzaglobalsolutions">Buy Webster now!</a> </div>
  <div class="clearfix content-chooser scrollbar">
    ...
    <ul class="layoutstyle clearfix">
      ...
      <li class="frame-layout" data-style="frame" title="frame"> Frame </li>
    </ul>
    <h3>Color Schemes</h3>
    ...
    <ul class="styleChange clearfix">
      ...
      <li class="skin-dark-pink" title="dark pink" data-style="skin-dark-pink"></li>
      ...
      <li class="skin-steelblue" title="steelblue" data-style="skin-steelblue" ></li>
      <li class="skin-water-blue" title="water blue" data-style="skin-water-blue" ></li>
      <li class="skin-yellow" title="yellow" data-style="skin-yellow" ></li>
      <li class="skin-persian-green" title="persian-green" data-style="skin-persian-green"></li>
      <li class="skin-perfume" title="perfume" data-style="skin-perfume"></li>
      <li class="skin-chestnut-rose" title="chestnut-rose" data-style="skin-chestnut-rose"></li>
      <li class="skin-blue-gem" title="blue gem" data-style="skin-blue-gem"></li>
      <li class="skin-malachite" title="malachite" data-style="skin-malachite"></li>
