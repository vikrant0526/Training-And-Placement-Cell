          ...
          <div class="row justify-content-center no-gutter">
            <div class="col-md-6 theme-bg">
              <div class="login-box pos-r text-white login-box-theme">
                <h2 class="text-white mb-16 text-left">Oops!!</h2>
                <br>
                <hr style="border-top: 1px solid white">
                <br>
                <p class="mb-10 text-white pl-1 text-capitalize text-justify">looks like your account is <strong>not valideted </strong>by the committee head. for more details fill the contact form with subject <strong>"Validate Me!"</strong>.</p>
                <br>
