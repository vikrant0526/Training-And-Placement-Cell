              ...
              <div class="login-box pb-50 clearfix white-bg">
                ...
                <form action="#" method="post">
                  <div class="section-field mb-20">
                    ...
                    <input id="name" class="web form-control" type="text" placeholder="Phone Number Or Email" name="uname">
                     <span class="error"><?php echo $unameeorr;?></span>  
                  </div>
                  <div class="section-field mb-20">
                    <label class="mb-10 text-dark font-weight-bold" for="Password">Password<label class="text-danger">*</label></label>
                    <input id="Password" class="Password form-control" type="password" placeholder="Password" name="pass">
...
<script src="../Files/js/custom.js"></script>
   ...
   <script>
    grecaptcha.ready(function() {
        grecaptcha.execute('6Lf1u9AUAAAAAM9UJ2yRLxC7l5WAJYjhIsb03g9Z', {action: 'homepage'}).then(function(token) {
           console.log(token);
