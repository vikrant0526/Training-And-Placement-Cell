        ...
        <div class="card h-100 ">
            <div class="card-body h-100">
                ...
                <div class="scrollbar">
                      ...
                      $row =$stmt3->rowCount();
                          if($row == 0){
                              ?>
                                        ...
                                        <td><a href="delete_student.php?sid=<?php echo $studdata["STUDENT_ID"]; ?>"><button
                    ...
                    <a href="STIPEND_entry.php?sid=<?php echo $selection_list_id; ?>"><input type="button"
                            value="Update Stipend" class="btn btn-sm btn-outline-success form-control"></a>
                </div>
            </div>
        </div>
    </div>
