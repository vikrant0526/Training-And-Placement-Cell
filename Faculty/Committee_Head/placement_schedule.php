           ...
           <div class="card-body h-100">
            ...
            <ul class="list-unstyled">
              ...
              <li>
                <div class="media">
                  <div class="media-body mb-2">
                    <input type="text" name="gap" class="form-control" placeholder="No of Days Per Company">
                  </div>
                </div>
              </li>
              <li>
                <div class="media">
                  <div class="media-body mb-2">
                    <input type="submit" name="submit" value="Generate Schedule" class="button button-border x-small">
                  </div>
                </div>
              </li>
              </form>
