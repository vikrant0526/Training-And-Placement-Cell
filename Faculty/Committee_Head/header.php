  ...
  <ul class="nav navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown mr-30">
      ...
      <div class="dropdown-menu dropdown-menu-right">
        ...
        <a class="dropdown-item" href="faculty_profile.php"><i class="text-warning ti-user"></i>Profile</a>
      ...
      <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
          ...
          <ul id="company" class="collapse" data-parent="#sidebarnav">
            ...
            <li class="text-nowrap"> <a href="view_schedule.php"><i class="fa fa-calendar-alt"></i>View Schedule</a> </li>
