...
?>
    ...
    <div class="content-wrapper header-info">
      ...
      <div class="mb-30">
           ...
           <div class="card-body h-100">
             <h4 class="card-title">Deactive Student</h4>
             <!-- action group -->
             <div class="scrollbar">
    ...
    function course(){
        ...
        function get_stud(){ 
            var xmlhttp=new XMLHttpRequest();
            xmlhttp.open("GET","get_deactive_stud.php?dept="+document.getElementById("dept").value+"&"+"degree="+document.getElementById("degree").value+"&"+"pyear="+document.getElementById("pyear").value,false);
            xmlhttp.send(null);
