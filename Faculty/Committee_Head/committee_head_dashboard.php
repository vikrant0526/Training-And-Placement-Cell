                ...
                <li class="">
                  <div class="media">
                    <div class="media-body">
                       ...
                       <a href="remove_notification.php?nid=<?php echo $data['NOTIFICATION_ID']; ?>"><button class="btn btn-sm btn-outline-secondary float-right ml-2 mb-2"><i class="fa fa-times"></i> Remove</button></a>
                       </p>
                       <div>
                         <hr>
                       </div>
