            ...
            <tr>
                <td>
                    <div style="height: 35px;width: 35px;border-radius: 50%;">
                        <img src="../../Student/Profile_pic/<?php echo $data['STUDENT_PROFILE_PIC'] ?>" alt="avatar" style="height: 100%;width: 100%;">
                    </div>
                </td>
                ...
                <td>
                    <a href="end_student_process.php?sid=<?php echo $data['STUDENT_ID']; ?>" title="">
                        <button class="btn btn-outline-danger" type="button"><i class="fas fa-user-slash"></i></button>
                    </a>
                </td>
            </tr>
<?php 
    }
    // print_r($_SESSION['view_student_data']);
?>
        </table>