...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/webster-responsive-multi-purpose-html5-template/login-09.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Dec 2019 09:41:56 GMT -->
  <head>
    ...
    <title>UTU | T&PCell | Company Sign-Up</title>
          ...
          <div class="row justify-content-center no-gutter">
            ...
            <div class="col-md-4">
              <div class="login-box pb-50 clearfix white-bg">
                ...
                <form action="company_reg_data_save.php" method="post">
                  <div class="section-field mb-20 row">
                    ...
                    <input id="name" class="web form-control col-8" type="email" pattern=(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|"(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21\x23-\x5b\x5d-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])*")@(?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?|\[(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?|[a-z0-9-]*[a-z0-9]:(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21-\x5a\x53-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])+)\]) 
                     title="Enter Valid Email" placeholder="Email" name="uname" required>
                  </div>
                  <div class="section-field mb-20 row">
                    <label class="mt-10 text-dark font-weight-bold col-4" for="Password">Password<label class="text-danger">*</label></label>
                    <input id="password2" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                     title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" class="Password form-control col-8" type="password" placeholder="Password" name="pass" onkeyup="checkPass();" required>
                  </div>
                  <div class="section-field mb-20 row">
                    <label class="mt-10 text-dark font-weight-bold col-4" for="Password">Re-Type Password<label class="text-danger">*</label></label>
                    <input id="confirm2" class="Password form-control col-8" type="password" placeholder="Re-Type Password" name="rpass" onkeyup="checkPass();" required>
