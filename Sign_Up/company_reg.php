              ...
              <div class="login-box pb-50 clearfix white-bg">
                ...
                <form action="company_reg_data_save.php" method="post">
                  <div class="section-field mb-20 row">
                    ...
                    <input id="name" class="web form-control col-8" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Example: abc@def.ghi or abc@def.ghi.jkl" placeholder="Email" name="uname" required>
                  </div>
                  <div class="section-field mb-20 row">
