                            ...
                            <div class="login-box pb-50 clearfix white-bg">
                                ...
                                <form action="#" method="post">
                                    <div class="section-field mb-20">
                                        <label class="mb-10 text-dark font-weight-bold" for="name">OTP<label
                                                class="text-danger">*</label></label>
                                        <input id="name" class="web form-control" maxlength="6"
                                            onkeypress="isInputNumber(event)" type="text" placeholder="Enter OTP"
                                            name="txt_otp" autofocus required>
                                    </div>
...
<?php
  ...
  if(isset($_REQUEST['Submit']))
  {
    ...
    echo "$uotp";
      ...
      {
        $_SESSION['cvotp']=1;
        header("location: ../Company/company_wizard.php");
      }
      else
      {
         ?>
