...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/webster-responsive-multi-purpose-html5-template/login-09.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Dec 2019 09:41:56 GMT -->
  <head>
    ...
    <title>UTU | T&PCell | Faculty Sign-Up</title>
          ...
          <div class="row justify-content-center no-gutter">
            ...
            <div class="col-md-4">
              <div class="login-box pb-50 clearfix white-bg">
                ...
                <form action="faculty_reg_data_save.php" method="post">
                  ...
                  <div class="section-field mb-20 row">
                    ...
                    <input id="password2"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                     title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" class="Password form-control col-8" class="Password form-control col-8" onkeyup="checkPass();" type="password" placeholder="Password" name="pass" required>
                  </div>
                  <div class="section-field mb-20 row">
