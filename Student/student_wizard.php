                            ...
                            <form class=""  action="#" method="post" enctype="multipart/form-data" id="default">
                                <fieldset title="Step1" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group row">  
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="fname" maxlength="20" class="form-control" placeholder="First Name" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">  
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Last Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="lname" maxlength="20" class="form-control" placeholder="Last Name" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">  
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Enrollment Number</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="enum" onkeypress="isInputNumber(event)" maxlength="15" class="form-control" placeholder="Enrollment Number" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">  
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Date of Birth</label>
                                        <div class="col-lg-6 col-md-9 col-sm-8">
                                            <div class="input-group date dpYears" data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="01-01-1995">
                                                <input type="text" class="form-control" name="dob" placeholder="01-01-1995" aria-label="Right Icon" aria-describedby="dp-ig" required>
                                ...
                                <fieldset title="Step 2" class="step" id="default-step-1" >
                                    <legend> </legend>
                                    <div class="form-group row">  
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Parent's Full Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" maxlength="20" name="pfname" placeholder="Parent's Full Name" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">  
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Parent's Email-ID</label>
                                        <div class="col-sm-8">
                                            <input type="email" class="form-control" name="pemail" placeholder="Parent's Email-ID" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">  
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Parent's Phone No.</label>
                                        <div class="col-sm-8">
                                            <input type="text" maxlength="10" onkeypress="isInputNumber(event)" class="form-control" name="ppno" placeholder="Parent's Phone Number"  required>
                                        </div>
                                    </div>
                                    <div class="form-group row">  
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Phone Number</label>
                                        <div class="col-sm-8">
                                            <input type="text" maxlength="10" onkeypress="isInputNumber(event)" class="form-control" name="pnum" placeholder="Student's Phone Number" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Address</label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" maxlength="255" rows="3" name="address" placeholder="Enter Your Address"></textarea>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset title="Step 3" class="step" id="default-step-2" >
                                    <legend> </legend>
                                    <div class="form-group row">  
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Department</label>
                                        <div class="col-sm-8">
                                            <select class="form-control" name="dept" id="dept" onchange="course()" required>
                                    ...
                                    <div class="form-group row">  
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Degree</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row">  
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Year Of Admission</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="yoa" maxlength="4" onkeypress="isInputNumber(event)" class="form-control" placeholder="Example: 2015"  required>
                                        </div>
                                    </div>
                                    <div class="form-group row">  
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Year Of Passing</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="yop" maxlength="4" onkeypress="isInputNumber(event)" class="form-control" placeholder="Example: 2015" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">About</label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" maxlength="255" name="about" cols="7" rows="5" placeholder="Tell us Something about you..." required></textarea>
                                        </div>
                                    </div><br><br>
                                </fieldset>
                                        ...
                                        <div class="form-group row">
                                            <div style="width: 125px;height: 125px; position: relative; overflow: hidden;border-radius: 50%;margin: auto auto">
                                                ...
                                                <input type="file" class="form-control" placeholder="Company L
                                                    ogo" name="profileImage" id="profileImage" onchange="displayImage(this)" accept="image/*" style="display: none;" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="btn btn-light col-4 offset-4" id="profileDisplay" onclick="triggerClick()">Choose A Profile Pic</label>
                                        </div><br><br><br>
                                    </fieldset>
