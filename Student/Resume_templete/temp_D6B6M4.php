                                ...
                                <div class='c-timeline__item'>
                                    ...
                                    <div class='o-content'>
                                        <div class='o-grid'>
                                            <div class='o-grid__col-md-5'>
                                                <h3 class='c-work__heading'>
                                                    <?php echo $data1['ACADEMIC_DIPLOMA_UNIVERSITY']; ?>
                                                </h3>
                                                <h3 class='c-work__heading t-primary-color'>
                                                    <?php echo $data1['ACADEMIC_DIPLOMA_SPECIALIZATION']; ?>
                                                </h3>
                                                <h4 class='c-work__title'>
                                                    <?php echo $data1['ACADEMIC_DIPLOMA_INSTITUTE']; ?>
                                                </h4>
                                                <div class='c-work__timeframe'>
                                                </div>
                                            </div>
                                            <div class='o-grid__col-md-7'>
                                                <div>
                                                    ...
                                                    $total=$data1['ACADEMIC_DIPLOMA_SEM_1'];
