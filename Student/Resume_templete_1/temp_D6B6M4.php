  ...
  <div class="wrapper-mid">
    ...
    <div id="paper">
      ...
      <div id="paper-mid">
       ...
       <div class="content">
            <p style="font-size: 16px;"><b>DIPLOMA</b></p>
            <p  style="font-size: 14px;"><?php $total=$data1['ACADEMIC_DIPLOMA_SEM_1'];
                         $total+=$data1['ACADEMIC_DIPLOMA_SEM_2'];
                         $total+=$data1['ACADEMIC_DIPLOMA_SEM_3'];
                         $total+=$data1['ACADEMIC_DIPLOMA_SEM_4'];
                         $total+=$data1['ACADEMIC_DIPLOMA_SEM_5'];
                         $total+=$data1['ACADEMIC_DIPLOMA_SEM_6']; 
                         $total/=6;
                         $total*=10;
                         echo round($total, 1);
                    ?><small>%</small></p>
              <p><?php echo $data1['ACADEMIC_DIPLOMA_INSTITUTE']; ?> <br />
              <em><?php echo $data1['ACADEMIC_DIPLOMA_UNIVERSITY']; ?></em>
               <em><?php echo $data1['ACADEMIC_DIPLOMA_SPECIALIZATION']; ?>
              </em>
            </p>
          </div>
          ...
          <div class="content">
            ...
            <p  style="font-size: 14px;"><?php $total=$data1['ACADEMIC_BACHELOR_SEM_3'];
                         $total+=$data1['ACADEMIC_BACHELOR_SEM_4'];
                         $total+=$data1['ACADEMIC_BACHELOR_SEM_5'];
                         $total+=$data1['ACADEMIC_BACHELOR_SEM_6'];
                         $total+=$data1['ACADEMIC_BACHELOR_SEM_7'];
                         $total+=$data1['ACADEMIC_BACHELOR_SEM_8'];
                         $total/=6;
                         $total*=10;
                         echo round($total, 1);
                    ?><small>%</small></p>
           ...
           <div class="content">
            <p style="font-size: 16px;"><b>MASTER</b></p>
            <p  style="font-size: 14px;"><?php $total=$data1['ACADEMIC_MASTER_SEM_1'];
                         ...
                         echo round($total, 1);
                    ?><small>%</small></p>
              <p><?php echo $data1['ACADEMIC_MASTER_INSTITUTE']; ?> <br />
              <em><?php echo $data1['ACADEMIC_MASTER_UNIVERSITY']; ?></em>
               <em><?php echo $data1['ACADEMIC_MASTER_DEGREE']; ?>
              (<?php echo $data1['ACADEMIC_MASTER_SPECIALIZATION']; ?>)</em>
            </p>
          </div>
